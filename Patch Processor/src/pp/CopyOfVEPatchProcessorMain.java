...
/** The main method to run the entire analysis.
 ...
 @version 2.0 (Published 6/10/2014)
 **/
...
public class CopyOfVEPatchProcessorMain extends ConsoleProgram {
	...
	public static void main(String[] args) {
		new CopyOfVEPatchProcessorMain().start(args);
		arguement = args;
	}
	...
	public void piMain() throws FileNotFoundException, IOException {
		...
		String fileName = path.getText();
		File files = new File(fileName);
		File result1 = new File(getDirectory(files), OFILE1);
		File result2 = new File(getDirectory(files), OFILE2);
