...
///** The old main method to run the entire analysis.
...
//				+ "be shown on the console window on the left. A \"result.pi\" file will also "
//				+ "be <br> created in your folder with more concise summary of all the "
//				+ "results analyzed. <br>(Note: Smooth factor (SF) if not entered will be "
//				+ "treated as default 2)<html>");
//
...
//		String fileName = path.getText();
//		File files = new File(fileName);
//		File result = new File(getDirectory(files), "result.pi");
